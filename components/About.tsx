...
function About(): JSX.Element {
  return (
    <section
      id="about"
      className="bg-gradient-to-r from-[#171717] to-black/90 flex flex-col 2xl:flex-row items-center space-x-0 2xl:space-x-10 py-16"
    >
      <div className="flex flex-col ml-16 basis-1/2">
        <h1 className="text-5xl text-white uppercase 2xl:text-6xl text-bold font-raleway">
          about the project
        </h1>
